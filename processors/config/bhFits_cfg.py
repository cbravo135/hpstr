...
bhfit = HpstrConf.Processor('bhfit', 'BhFitSandboxProcessor')

###############################
#   Processor Configuration   #
###############################
#MCParticles
bhfit.parameters["debug"] = 1
bhfit.parameters["massSpectrum"] = options.mass_spec
bhfit.parameters["mass_hypo"] = mass_hypo
bhfit.parameters["poly_order"] = poly_order
bhfit.parameters["win_factor"] = win_factor
bhfit.parameters["seed"] = 0
bhfit.parameters["nToys"] = options.nToys
bhfit.parameters["toy_sig_samples"] = options.toy_sig_samples
bhfit.parameters["toy_bkg_mult"] = options.toy_bkg_mult
bhfit.parameters["res_scale"] = options.res_scale
bhfit.parameters["signal_shape_h_name"] = options.signal_shape_h_name
bhfit.parameters["signal_shape_h_file"] = options.signal_shape_h_file
