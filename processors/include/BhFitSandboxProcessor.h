#ifndef __BHFIT_SANDBOXPROCESSOR_H__
#define __BHFIT_SANDBOXPROCESSOR_H__
...
class BhFitSandboxProcessor : public Processor {

    public:

        BhFitSandboxProcessor(const std::string& name, Process& process);

        ~BhFitSandboxProcessor();
